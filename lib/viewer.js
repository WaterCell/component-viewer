...
/***/ function(module, exports, __webpack_require__) {
	...
	var _riot = __webpack_require__(173);
	...
	_riot2['default'].mount('viewer-main', { components: components, styles: styles });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./viewer.styl", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/stylus-loader/index.js!./viewer.styl");
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag('viewer-main', '<viewer-header></viewer-header> <viewer-sidebar components="{ opts.components }"></viewer-sidebar> <viewer-frame styles="{ opts.styles }"></viewer-frame>', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag('viewer-component', '<div class="{inner: true, selected: selected}" onclick="{ toggleScenarios }">{ module.name || name }</div> <div class="{scenario: true, selected: parent.selected === name}" if="{ parent.showScenarios }" each="{ name, data in module.scenarios }" onclick="{ parent.onSelect }">{ name }</div>', function(opts) {var _this = this;
	...
	this.toggleScenarios = function () {
	  if (_this.module.scenarios && _lodash2['default'].keys(_this.module.scenarios).length > 1) {
	    _this.showScenarios = !_this.showScenarios;
	  } else {
	    _this.selected = _lodash2['default'].keys(_this.module.scenarios)[0];
	    _utils.radio.trigger('component.changed', _this);
	  }
	};
	...
	this.onSelect = function (event) {
	  ...
	  _this.selected = event.item.name;
	  _utils.radio.trigger('component.changed', _this);
	};

	_utils.radio.on('component.changed', function (tag) {
	  if (tag !== _this) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var radio = _riot2['default'].observable();
	exports.radio = radio;
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag('viewer-component-list', '<h4>Components</h4> <viewer-component each="{ opts.components }"></viewer-component>', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag('viewer-header', '<h1>Component Viewer</h1>', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag('viewer-frame', '<div class="container"> <iframe id="frame"></iframe> </div>', function(opts) {var _this = this;
	...
	var _containerJade = __webpack_require__(183);

	var _containerJade2 = _interopRequireDefault(_containerJade);

	window.frameReloaded = function () {
	  if (_this.currentComponent) {
	    _this.frame.contentWindow.go((0, _containerJade2['default'])({
	      componentSource: '' + _this.currentComponent.buildPath,
	...
	this.loadFrame = function () {
	  _this.frame.setAttribute('src', '//' + window.location.host + '/frame.html');
	};
	...
	this.setSize = function () {
	  ...
	  _this.frame.style.width = width + 'px';
	...
	this.startResize = function (event) {
	  ...
	  _this.x = event.pageX;
	  _this.y = event.pageY;
	  var rect = _this.frame.getBoundingClientRect();
	  _this.width = rect.width;
	  _this.height = rect.height;

	  document.addEventListener('mousemove', _this.enactResize);
	};

	this.enactResize = function (event) {
	  event.preventDefault();
	  var width = Math.max(_this.width + (event.pageX - _this.x), 0),
	      height = Math.max(_this.height + (event.pageY - _this.y), 0);
	  _this.setSize(width, height);
	  _utils.radio.trigger('resolution.update', width, height);
	};

	this.endResize = function (event) {
	  event.preventDefault();
	  document.removeEventListener('mousemove', _this.enactResize);
	};

	this.startTimeout = function (event) {
	  if (_this.timeout) {
	...
	this.cancelTimeout = function (event) {
	  if (_this.timeout) {
	    clearTimeout(_this.timeout);
	    _this.timeout = null;
	  }
	...
	this.on('mount', function () {
	  var rect = _this.frame.getBoundingClientRect();
	  _utils.radio.trigger('resolution.update', rect.width, rect.height);
	});

	_utils.radio.on('component.changed', function (tag) {
	  _this.currentComponent = tag;
	  _utils.radio.trigger('scenario.changed', tag.selected || 'default');
	});
	_utils.radio.on('scenario.changed', function (scenario) {
	  _this.currentScenario = scenario;
	  _this.loadFrame();
	});
	_utils.radio.on('resolution.preset', function (resolution) {
	  var dim = { width: 100, height: 100 };

	  if (resolution !== 'preferred') {
	    var _resolution$split = resolution.split('x');

	    var _resolution$split2 = _slicedToArray(_resolution$split, 2);

	    dim.width = _resolution$split2[0];
	    dim.height = _resolution$split2[1];
	  } else {
	    var scenarios = _this.currentComponent && _this.currentComponent.module.scenarios;
	    var current = scenarios && scenarios[_this.currentScenario];
	    var moduleDimensions = _this.currentComponent && _this.currentComponent.module.dimensions;

	    if (current && current.dimensions) {
	      dim = current.dimensions;
	    } else if (moduleDimensions) {
	      dim = _this.currentComponent.module.dimensions;
	    }
	  }
	  _this.setSize(dim.width, dim.height);
	});
	...
	window.onload = function () {
	  ...
	  var inners = document.querySelectorAll('viewer-component > div.inner');
	  var _iteratorNormalCompletion = true;
	  var _didIteratorError = false;
	  var _iteratorError = undefined;

	  try {
	    for (var _iterator = inners[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var jade = __webpack_require__(184);

	module.exports = function template(locals) {
	var buf = [];
	var jade_mixins = {};
	var jade_interp;
	;var locals_for_with = (locals || {});(function (componentSource, scenario, styles, undefined) {
	buf.push("<div id=\"content\"></div>");
	// iterate styles
	;(function(){
	  var $$obj = styles;
	...
	buf.push("<script>var e = document.createElement('link');\ne.setAttribute('href', '/" + (jade.escape((jade_interp = style) == null ? '' : jade_interp)) + "');\ne.setAttribute('rel', 'stylesheet');\ndocument.head.appendChild(e);\n</script>");
	    }

	  } else {
	    var $$l = 0;
	    for (var $index in $$obj) {
	      $$l++;      var style = $$obj[$index];
	...
	buf.push("<script>window.scenario = '" + (jade.escape((jade_interp = scenario) == null ? '' : jade_interp)) + "';\n</script><script async=\"async\"" + (jade.attr("src", '' + (componentSource) + '', true, false)) + "></script>");}.call(this,"componentSource" in locals_for_with?locals_for_with.componentSource:typeof componentSource!=="undefined"?componentSource:undefined,"scenario" in locals_for_with?locals_for_with.scenario:typeof scenario!=="undefined"?scenario:undefined,"styles" in locals_for_with?locals_for_with.styles:typeof styles!=="undefined"?styles:undefined,"undefined" in locals_for_with?locals_for_with.undefined: false?undefined:undefined));;return buf.join("");
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.rethrow = function rethrow(err, filename, lineno, str){
	  ...
	  try {
	    str = str || __webpack_require__(185).readFileSync(filename, 'utf8')
	  } catch (ex) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag('viewer-sidebar', '<viewer-options></viewer-options> <viewer-component-list components="{ opts.components }"></viewer-component-list>', function(opts) {
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(riot) {riot.tag('viewer-options', 'Resolution: <select id="resolution" onchange="{ presetSelected }"> <option id="custom" selected></option> <optgroup label="-------"> <option value="preferred">preferred</option> </optgroup> <optgroup label="-------"> <option>1280x720</option> <option>786x500</option> <option>200x400</option> </optgroup> </select>', function(opts) {var _this = this;

	var _utils = __webpack_require__(177);

	this.setOption = function (width, height) {
	  _this.custom.textContent = width + 'x' + height;
	};

	this.presetSelected = function () {
	  _utils.radio.trigger('resolution.preset', _this.resolution.value);
	};

	_utils.radio.on('resolution.update', function (width, height) {
	  var selected = _this.resolution.querySelectorAll('option');
	  if (selected[_this.resolution.selectedIndex] !== _this.custom) {
	    _this.resolution.value = _this.custom.textContent;
	  }
	  _this.setOption(width, height);
	});
	});
